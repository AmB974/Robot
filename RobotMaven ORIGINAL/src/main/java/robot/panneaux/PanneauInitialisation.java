...
public class PanneauInitialisation extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        robot1 = new JButton("Robot 1");
        robot2 = new JButton("Robot 2");
        robot3 = new JButton("Robot 3");
        robot4 = new JButton("Robot 4");
        //Ajouté par Sélim
        ...
        comboPositionRobot.addActionListener(new java.awt.event.ActionListener() {
            @Override
        ...
        comboOrientationRobot.addActionListener(new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        robot1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                robot1DefinieActionPerformed(evt);
            }
        });

        robot2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                robot2DefinieActionPerformed(evt);
            }
        });

        robot3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                robot3DefinieActionPerformed(evt);
            }
        });

        robot4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                robot4DefinieActionPerformed(evt);
            }
        });
    ...
    private void comboOrientationRobotItemStateChanged(ActionEvent evt) {//GEN-FIRST:event_comboOrientationRobotItemStateChanged
    ...
    private void comboPositionRobotItemStateChanged(ActionEvent evt) {//GEN-FIRST:event_comboPositionRobotItemStateChanged
        // TODO add your handling code here:
        if (changementInterne) return;
    ...
    private void robot1DefinieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboPositionMineraiItemStateChanged
        if (changementInterne) return;
        ROBOTSELECTIONNE = 1;
    }// Ajouté par Sélim

    private void robot2DefinieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboPositionMineraiItemStateChanged
        if (changementInterne) return;
        ROBOTSELECTIONNE = 2;
    }// Ajouté par Sélim

    private void robot3DefinieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboPositionMineraiItemStateChanged
        if (changementInterne) return;
        ROBOTSELECTIONNE = 3;
    }// Ajouté par Sélim

    private void robot4DefinieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboPositionMineraiItemStateChanged
        if (changementInterne) return;
        ROBOTSELECTIONNE = 4;
    }//Ajouté par Sélim

    private void deselectionneListes()
    {
        comboOrientationRobot.setSelectedItem(0);
        comboPositionRobot.setSelectedItem(0);
    }// Ajouté par Sélim

    public static void selectionneRobotUn()
    {
        ROBOTSELECTIONNE=1;
    }//Ajouté par Sélim
    ...
    private JButton robot2;
    private JButton robot3;
    private JButton robot4;
