...
public class TantQue extends InstructionComposee {
    ...
    static {
        Image tmp = new ImageIcon(TantQue.class.getResource("/images/TQ.png")).getImage().getScaledInstance(25, 25, Image.SCALE_AREA_AVERAGING);
    ...
    public ImageIcon getIcon() {
        // Ca marche bien mais comme ça l'icone s'écrit avant le texte
